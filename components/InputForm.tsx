...
import { SOIL_TYPES, UI_TEXT, FORECAST_DURATIONS, SOIL_TYPE_TRANSLATIONS } from '../constants';
import { Language, SoilType, ForecastDuration } from '../types';
